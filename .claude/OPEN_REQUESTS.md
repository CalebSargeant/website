...
- [x] ~~Optional: an apex -> www 301~~ DONE THE OTHER WAY ROUND. A zone Redirect
      Rule now 301s www to the apex, and every canonical names the apex
      (feat/ai-seo-mcp-corpus). Do not add an apex -> www rule: with this one in
      place it would be a redirect loop.
